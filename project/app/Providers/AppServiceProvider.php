    ...
    public function boot()
    {
        ...
        view()->composer('admin.partials.sidebar', function ($view) {
            $view->with([
                ...
                'pending_driver_kyc'    =>  Driver::whereStatus(1)->where('kyc_status',2)->count(),
                ...
                'pending_driver_ticket' =>  SupportTicket::where('user_type',2)->whereStatus(0)->whereHas('messages')->count(),
