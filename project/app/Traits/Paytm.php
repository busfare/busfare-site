...
trait Paytm {
	    ...
	    public function handlePaytmRequest( $order_id, $amount, $type ) {
            ...
            $paytm_driver_key = $paydata['secret'];
            //Here checksum string will return by getChecksumFromArray() function.
            $checkSum = getChecksumFromArray( $paramList, $paytm_driver_key );
            return array(
                'checkSum' => $checkSum,
                'paramList' => $paramList
            );
        ...
        function getConfigPaytmSettings() {
            ...
            define('PAYTM_MERCHANT_KEY', $paydata['secret']); //Change this constant's value with Driver key downloaded from portal
            define('PAYTM_MERCHANT_MID', $paydata['driver']); //Change this constant's value with MID (Driver ID) received from Paytm
            define('PAYTM_MERCHANT_WEBSITE', $paydata['website']); //Change this constant's value with Website name received from Paytm
            $PAYTM_STATUS_QUERY_NEW_URL='https://securegw-stage.paytm.in/driver-status/getTxnStatus';
            $PAYTM_TXN_URL='https://securegw-stage.paytm.in/theia/processTransaction';
            if (PAYTM_ENVIRONMENT == 'PROD') {
                $PAYTM_STATUS_QUERY_NEW_URL='https://securegw.paytm.in/driver-status/getTxnStatus';
