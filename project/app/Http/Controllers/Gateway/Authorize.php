...
class Authorize {
    ...
    public function initiate($request,$payment_data,$type)
    {
        ...
        if ($validator->passes()) {
            ...
            $driverAuthentication = new AnetAPI\DriverAuthenticationType();
            $driverAuthentication->setName($paydata['login_id']);
            $driverAuthentication->setTransactionKey($paydata['txn_key']);
            ...
            $requestt->setDriverAuthentication($driverAuthentication);
