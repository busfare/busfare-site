...
class DriverController extends ApiController
{
    public function dashboard()
    {
        ...
        $success['recent_withdraw']  = Withdrawals::where('driver_id',$user->id)->take(7)->get();
    ...
    {
        $user = request()->user();
        $cred = ApiCreds::whereDriverId($user->id)->first();
        if(!$cred){
            ApiCreds::create([
                'driver_id' => driver()->id,
    ...
    public function transactions()
    {
        ...
        $success['remark_list'] = [
            'driver_payment','driver_api_payment','withdraw_money'
        ];
