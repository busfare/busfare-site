...
class UserController extends ApiController{
    ...
    public function transactions()
    {
        ...
        $success['remark_list'] = [
            'transfer_money','request_money','money_exchange','invoice_payment','driver_payment','driver_api_payment','escrow_return','make_escrow','withdraw_money','withdraw_reject','redeem_voucher',
