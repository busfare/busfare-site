...
@section('breadcrumb')
 <section class="section">
    <div class="section-header justify-content-between">
        ...
        <a href="{{route('admin.driver.index')}}" class="btn btn-primary"><i class="fas fa-backward"></i> @lang('Back')</a>
    </div>
</section>
@endsection
        ...
        <div class="col-xxl-8 col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="mt-3">@lang('Driver details')</h6>
                    <hr>
                    <form action="{{route('admin.driver.profile.update',$user->id)}}" method="POST" class="row">
                        @csrf
                        @if ($user->api)
            ...
            <div class="card">
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        @if (access('driver login'))
                        <li class="list-group-item d-flex justify-content-between">@lang('Login to Driver') <span><a target="_blank" href="{{route('admin.driver.login',$user->id)}}" class="btn btn-dark">@lang('Login')</a></span></li>
                        @endif
                        <li class="list-group-item d-flex justify-content-between">@lang('Driver Login Info') <span><a href="{{route('admin.driver.login.info',$user->id)}}" class="btn btn-dark">@lang('View')</a></span></li>
                    </ul>
                </div>
            </div>
        </div>
