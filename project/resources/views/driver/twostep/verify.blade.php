                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                           <h6>@lang('Please check your phone number to get OTP code. Your phone number is : '.driver()->phone)</h6>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group d-flex justify-content-between">
                            <a href="{{route('driver.two.step.resend')}}" class="text-left">@lang('Didn\'t get code? Resend.')</a>
