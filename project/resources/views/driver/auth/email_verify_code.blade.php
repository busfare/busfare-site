...
@section('title')
    @lang('Driver Email Verification')
@endsection
...
<div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
    <div class="card card-primary logincard">
      ...
      <div class="card-body">
         ...
         @endif
        <form method="POST" action="{{route('driver.verify.email')}}" class="needs-validation">
            @csrf
                ...
                <div class="form-group">
                    <a href="{{route('driver.verify.email.resend')}}">@lang('Resend Code')</a>
                </div>
