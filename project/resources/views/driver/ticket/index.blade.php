...
@section('content')
                            ...
                            <div class="tab-pane show fade active" id="c1">
                                <div class="chat__msg">
                                    ...
                                    <div class="chat__msg-footer">
                                        <form action="{{route('driver.ticket.reply',request('messages'))}}" class="send__msg" method="post" enctype="multipart/form-data">
                                            @csrf
        ...
        <div class="modal fade" id="modelId" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog" role="document">
               <form action="{{route('driver.ticket.open')}}" method="POST">
                @csrf
