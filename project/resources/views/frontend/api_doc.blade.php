                ...
                <div class="col-lg-10">
                    <div class="documentation-wrapper">
                        <div class="documentation-item" id="intro">
                            ...
                            <p>
                               @lang(' All requests to the') {{$gs->title}} @lang('API are sent via the HTTP POST method to one of our API endpoint URLs').
                                ...
                                @lang('All calls to the') {{$gs->title}} @lang('API require driver authentication and driver access key.') <a href="{{url('driver/register')}}">@lang('Sign up')</a> @lang('for a  account to quickly get started').
                                <br>
                                @lang('Sandbox payment can be also initiated while driver set the service mode as test in driver dashboard. It will be live while the mode will be set as active mode.')
                            </p>
                        ...
                        <div class="documentation-item" id="api">
                            ...
                            <p>
                               @lang('Register as a driver in our system. In your driver dashboard you will find the option for API access key.') <br><br>
