...
use App\Http\Controllers\Admin\ManageDriverController;
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('auth:admin')->group(function(){
        ...
        //driver
            ...
            Route::get('manage-drivers', [ManageDriverController::class,'index'])->name('driver.index')->middleware('permission:manage driver');

            Route::get('driver-details/{id}', [ManageDriverController::class,'details'])->name('driver.details')->middleware('permission:edit driver');

            Route::post('driver/balance-modify', [ManageDriverController::class,'modifyBalance'])->name('driver.balance.modify')->middleware('permission:driver balance modify');

            Route::post('driver-profile/update/{id}', [ManageDriverController::class,'profileUpdate'])->name('driver.profile.update')->middleware('permission:update driver');

            Route::get('driver-login/{id}', [ManageDriverController::class,'login'])->name('driver.login')->middleware('permission:driver login');

            Route::get('driver-login/info/{id}', [ManageDriverController::class,'loginInfo'])->name('driver.login.info')->middleware('permission:driver login logs');
